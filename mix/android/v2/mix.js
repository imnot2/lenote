    ...
    Parser.prototype = {
        ...
        getSuffix: function(suffix){
            ...
            switch(suffix){
                ...
                case 'txt':case 'rtf': _suffix = 'txt';break;
        ...
        buildPhoto: function(tag, resource, width){
            ...
            var photo = document.createElement('img'),
                src = (typeof resource == 'object')? resource.src : 'images/img404.png';
        ...
        buildAudio: function(tag){
            ...
            var bw = this.width, bh = parseInt(bw / 3.2), pwh = parseInt(bw / 5.1),
        ...
        buildMixText: function(tag){
            ...
            text.className = 'item clearfix text', text.setAttribute('time', resource.starttime);
        ...
        buildMixPhoto: function(tag){
            ...
            photo.className = 'item clearfix photo', photo.setAttribute('time', resource.starttime);
            ...
            for(var i = 0; i < audios.length; i++){
                audios[i].addEventListener('click', function(e){
                    ...
                    if(play_img.getAttribute('play') == 0){
                      ...
                      if(play_img.hasAttribute('belong')) behavior.slide(id, 0, 50, true);
                    }else{
