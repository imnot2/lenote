...
CREATE TABLE IF NOT EXISTS `client` (
  ...
  KEY `status` (`status`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='客户端' AUTO_INCREMENT=3 ;
...
(2, 2, 'http://susapi.lenovomm.com/adpserver/DLBIDFS?ds=20069_20531368&rt=POL', '1.1.24', '19.50M', '2014-06-17 11:34:05', 1, 'windows客户端', NULL, NULL, '2014-06-17 11:34:05', '2014-06-17 11:34:05');
