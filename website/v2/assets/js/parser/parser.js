...
(function(){
    ...
    Parser.prototype = {
        ...
        getMkey: function(key){
            ...
            return resource? resource['clientMixID'] : '';
        },
        ...
        pretreatment: function(){
            ...
            for(var i = 0; i < tags.length; i++){
                ...
                var _type = lenoteTag.isSupportForWeb(lenoteTag.validType(resource.resourceName, resource._type)),
        ...
        buildPhotoGroup: function(photos, phototime){
            ...
            for(var i in photos){
                ...
                if(typeof photos[i] == 'object') res += this.buildPhoto(photos[i], null, this.width);
            }
        ...
        analyzeMix: function(){
             ...
             for(var i in result){
                 var item = result[i];
                 if(item.tag) item.tag.replaceWith(item.mix);
             }
